...
public class ItemModel {
    ...
    String itemId, itemOrder, catId, subCatId, itemName, itemSmallDesc, itemImage, itemVisivility, itemPrice, foodStyle, itemStatus, itemFullDescription,parentCatName,category,Size,Base,Has_subitem,no_of_toppings;
